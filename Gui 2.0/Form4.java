...
public class Form4 extends JFrame implements ActionListener
{
	...
	public Form4()
 {
	...
	l1 = new JLabel("Police Information");
		l1.setForeground(Color.YELLOW);
		l1.setBounds(900,30,300,200);
		l1.setFont(new Font("Arial",Font.BOLD,35));
		p1.add(l1);

    l2 = new JLabel("Police Name:");
    ...
    l4 = new JLabel("Police Age:");
		l4.setForeground(Color.YELLOW);
		l4.setBounds(770,550,150,50);
		l4.setFont(new Font("Tahoma",Font.BOLD,15));
		p1.add(l4);

    l5 = new JLabel("Police Gender:");
